...
// Init
+ (CollapseClickCell *)newCollapseClickCellWithTitle:(NSString *)title subTitle:(NSString *)subtitle index:(int)index content:(UIView *)content;
