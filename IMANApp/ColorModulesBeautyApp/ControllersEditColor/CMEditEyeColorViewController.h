//
//  CMEditEyeColorViewController.h
...
@interface CMEditEyeColorViewController : UIViewController <UITableViewDelegate, UITableViewDataSource>

@property (strong, nonatomic) UIColor *mEyeColorCode;
