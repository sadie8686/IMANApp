//  CMEditLipsColorViewController.h
...
@interface CMEditLipsColorViewController : UIViewController <UITableViewDelegate, UITableViewDataSource>
@property (strong, nonatomic) UIColor *mLipsColorCode;
