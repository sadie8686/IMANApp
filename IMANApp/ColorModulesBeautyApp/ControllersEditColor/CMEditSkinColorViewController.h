//
//  CMEditSkinColorViewController.h
...
@interface CMEditSkinColorViewController : UIViewController <UITableViewDelegate, UITableViewDataSource>

@property (strong, nonatomic) UIColor *mSkinColorCode;
