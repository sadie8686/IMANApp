...
- (UIImage *)trackBackgroundImage
{
    ...
    {
        UIImage* image = [UIImage imageNamed:@"horizontal_price_bar_grey.png"];
...
- (UIImage *)trackImage
{
    if(_trackImage==nil)
    {
        UIImage* image = [UIImage imageNamed:@"horizontal_price_bar.png"];
        image = [image resizableImageWithCapInsets:UIEdgeInsetsMake(0.0, 5.0, 0.0, 5.0)];
        _trackImage = image;
    }
...
- (UIImage *)lowerHandleImageNormal
{
    ...
    {
        UIImage* image = [UIImage imageNamed:PRICE_ARROW_DOWN_IMG];
